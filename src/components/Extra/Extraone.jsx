  ...
  return (
    <div className="container mx-auto my-24">
      <p
        ...
        className="text-center my-20 font-bold text-2xl lg:text-5xl"
      >
        Why Choose Us
      </p>
      <div className="lg:flex ml-5 md:ml-44 lg:ml-0 justify-center gap-12">
        ...
        >
          <div className="flex justify-center">
            <FcInTransit className="w-8 h-8" />
          </div>
          <p className="mt-5 mb-3 font-bold text-2xl">FAST DEVIVERY</p>
          <p>
            Our delivery team always ready to deliver your desire food . So that
        ...
        >
          ...
          <p>
            We provide 24/7 customer Support . They can ask any question about
