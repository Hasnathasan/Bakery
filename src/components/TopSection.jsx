  ...
  return (
    <div className="my-20 container mx-auto">
      <div
        ...
        className="text-center text-amber-700 font-bold text-3xl lg:text-5xl"
      >
      ...
      <div className="flex justify-center">
        ...
        >
          <NavLink to="/allfoods" className="flex gap-3 text-lg  ">
            <p>See All</p> <AiOutlineArrowRight className="mt-1.5" />
          </NavLink>
        </motion.button>
      </div>
    </div>
