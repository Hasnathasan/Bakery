        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute inset-0 grid h-full w-full items-center bg-black/75">
            <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
              ...
              >
                You’ll find dozens of muffin recipes here, from healthy and
                wholesome options like morning glory muffins and applesauce
                muffins.
              </Typography>
              <div className="flex gap-2">
                ...
                >
                  {" "}
                  <NavLink to="/allfoods">All Items</NavLink>
                </motion.button>
              </div>
            </div>
          </div>
